...
但实际上一张立方体贴图的每个 mipmap 级别拥有 6 个面，每个面都有一个 uv 坐标，如下图：
...
<div  align="center">  
<img src="https://s2.loli.net/2024/07/27/iC8K6nWRz9D4PEX.png" width = "100%" height = "100%" alt="图6 - 原经纬图（上图）与黎曼和采样后的辐射照度图（下图）"/>
</div>
