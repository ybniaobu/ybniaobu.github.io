...
## 球面映射 Sphere Mapping
**球面映射 Sphere mapping** 假定观察者以正交投影的方式观察一个完美反射的球体，这个球体捕捉各个方向上的光照信息。由此产生的圆形图像也称为**光照探针 light probe**。
...
待整理：
天空盒是无限大，所以可以忽略位置信息而只考虑法线信息，可以认为着色点就位于天空盒中心

kd 不能移出的问题，kd = (1 - F)(1 - metallic)
