...
<div  align="center">  
<img src="https://s2.loli.net/2024/10/27/7KuMzwCpHoghBv8.jpg" width = "70%" height = "70%" alt="图7 - energy compensation"/>
</div>

高粗糙度时确实亮了，但是不知道为什么，效果非常不连续，看起来很难受。我研究了一下原因，是因为我选用的 Diffuse 模型以及 $\,(1 - F)(1 - Metallic)\,$ 所导致的不连续变化，Diffuse 选用 Lambert 模型，并且只用 $\,(1 - Metallic)\,$ 插值就变得特别舒服，效果如下：  

<div  align="center">  
<img src="https://s2.loli.net/2024/10/27/M28unbGFIlrxYSX.jpg" width = "70%" height = "70%" alt="图7 - 选用 Lambert 模型以及 1 - Metallic 插值后的 energy compensation 效果"/>
</div>

> 我的解决方案是将 Standard Shader 和 Standard_EnergyCompensation Shader 分开，Standard Shader 选用 Renormalized Disney diffuse 以及 $\,(1 - F)(1 - Metallic)\,$ 的插值方案，Standard_EnergyCompensation Shader 选用 Lambert diffuse 以及 $\,(1 - Metallic)\,$ 的插值方案。其实我觉得这部分没必要较真，真正让画面提升的不是这些细节上的东西，更重要的还是在全局光照和色彩管理上。
