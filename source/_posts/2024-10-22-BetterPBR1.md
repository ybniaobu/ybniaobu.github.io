...
# Ambient Occlusion
这里补充一点**环境光遮蔽 Ambient Occlusion** 的基础知识，首先环境光遮蔽可以分为三个级别：  
**①Small scale**：微观级别的遮蔽，比如一些折痕、裂缝和小窟窿等，这些微观级别在有些工具或引擎中用**缝隙图 Cavity Map** 来表达。而一般在游戏引擎中，都会直接烘焙进 base color map；  
**②Medium scale**：
