...
除了 particle shader，后处理中的 Bloom 也要修改分辨率（UberPost 不用修改，因为 UberPost 输出对象是 CameraTarget）：  
...
<div  align="center">  
<img src="https://s2.loli.net/2025/04/25/3ciAFzNtWIdjoLD.png" width = "40%" height = "40%" alt="图127 - 上：render scale 0.5 和 2 时 HDR 产生的颜色带；下：render scale 0.5, 1, 以及 2 时，Strong red midtones 调整后产生的颜色带"/>
</div>
