...
$$ \begin{align*} L_c &= \cfrac {\frac {1} {N} \sum_{k = 1}^N \cfrac{ D(\omega_h) F(\omega_h, \omega_o) G(\omega_i, \omega_o) L_i(p, \omega_i) n \cdot \omega_i } {4 (n \cdot \omega_i)(n \cdot \omega_o) \cfrac {D(\omega_h)(n \cdot \omega_h)} {4(\omega_o \cdot \omega_h)}}} {\frac {1} {N} \sum_{k = 1}^N \cfrac{ D(\omega_h) F(\omega_h, \omega_o) G(\omega_i, \omega_o) n \cdot \omega_i } {4 (n \cdot \omega_i)(n \cdot \omega_o) \cfrac {D(\omega_h)(n \cdot \omega_h)} {4(\omega_o \cdot \omega_h)}}} \\ &= \cfrac {\frac {1} {N} \sum_{k = 1}^N \cfrac{ F(\omega_h, \omega_o) G(\omega_i, \omega_o) L_i(p, \omega_i) } {4 (n \cdot \omega_o) \cfrac {(n \cdot \omega_h)} {4(\omega_o \cdot \omega_h)}}} {\frac {1} {N} \sum_{k = 1}^N \cfrac{ F(\omega_h, \omega_o) G(\omega_i, \omega_o) } {4 (n \cdot \omega_o) \cfrac {(n \cdot \omega_h)} {4(\omega_o \cdot \omega_h)}}} \end{align*} $$
