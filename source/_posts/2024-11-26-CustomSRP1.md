...
# Directional Lights
这个章节的内容就可以开始和 [Custom Better PBR in Unity](https://ybniaobu.github.io/2024/10/22/2024-10-22-BetterPBR1/) 的直接光部分结合在一起了。从这里开始，我会和我的 YPipeline 结合在一起边学边写，所以有些做法和写的函数会和 Catlike Coding 教程不太一样，有些我感觉没必要说的我也会跳过。另外，本章内容只考虑**方向光 Directional Light**。
